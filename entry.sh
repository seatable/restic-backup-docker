...
log "DEBUG" "SEAFILE_DATABASE_DUMP: ${SEAFILE_DATABASE_DUMP}"
log "DEBUG" "SEAFILE_DATABASE_HOST: ${SEAFILE_DATABASE_HOST}"
log "DEBUG" "SEAFILE_DATABASE_USER: ${SEAFILE_DATABASE_USER}"
